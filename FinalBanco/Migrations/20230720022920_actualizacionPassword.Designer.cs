...
namespace FinalBanco.Migrations
{
    ...
    [Migration("20230720022920_actualizacionPassword")]
    partial class actualizacionPassword
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinalBanco.Models.CajaDeAhorro", b =>
                {
            ...
            modelBuilder.Entity("FinalBanco.Models.Movimiento", b =>
                {
            ...
            modelBuilder.Entity("FinalBanco.Models.Pago", b =>
                {
            ...
            modelBuilder.Entity("FinalBanco.Models.PlazoFijo", b =>
                {
            ...
            modelBuilder.Entity("FinalBanco.Models.TarjetaDeCredito", b =>
                {
            ...
            modelBuilder.Entity("FinalBanco.Models.Usuario", b =>
                {
                    b.Property<int>("_id_usuario")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FinalBanco.Models.UsuarioCajaDeAhorro", b =>
                {
                    b.Property<int>("_id_caja")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FinalBanco.Models.Movimiento", b =>
                {
                    b.HasOne("FinalBanco.Models.CajaDeAhorro", "_cajaDeAhorro")
            ...
            modelBuilder.Entity("FinalBanco.Models.Pago", b =>
                {
                    b.HasOne("FinalBanco.Models.Usuario", "_usuario")
                        .WithMany("_pagos")
            ...
            modelBuilder.Entity("FinalBanco.Models.PlazoFijo", b =>
                {
                    b.HasOne("FinalBanco.Models.Usuario", "_titular")
            ...
            modelBuilder.Entity("FinalBanco.Models.UsuarioCajaDeAhorro", b =>
                {
                    b.HasOne("FinalBanco.Models.CajaDeAhorro", "caja")
                        .WithMany("usuarioCajas")
                        .HasForeignKey("_id_caja")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FinalBanco.Models.Usuario", "user")
                        .WithMany("usuarioCajas")
                        .HasForeignKey("_id_usuario")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
